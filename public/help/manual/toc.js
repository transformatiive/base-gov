(function (w) {
  ...
  w.BRHelpManualToc = {
    ...
    chapters: [
      ...
      { slug: 'carteira', title: 'Carteira', group: 'Dia a dia', href: '#/pipeline', html: '/help/manual/carteira.html', shots: [] },
      { slug: 'oportunidades', title: 'Oportunidades', group: 'Dia a dia', href: '#/radar/opportunities', html: '/help/manual/oportunidades.html', shots: [], pro: true },
      ...
      { slug: 'concorrentes', title: 'Concorrentes', group: 'Mercado', href: '#/radar/competitors', html: '/help/manual/concorrentes.html', shots: [], pro: true },
      { slug: 'entidades', title: 'Entidades', group: 'Mercado', href: '#/entities', html: '/help/manual/entidades.html', shots: [], pro: true },
